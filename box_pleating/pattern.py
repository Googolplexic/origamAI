...
class BoxPleatingPattern:
    ...
    def _print_violation_details(
        ...
        """Print detailed information about theorem violations at a vertex."""
        ...
        if not kawasaki_valid:
            ...
            if "error" in kawasaki_details:
                ...
                print(f"    Sum of even angles: {kawasaki_details['sum_even']:.2f}°")
                print(f"    Difference: {kawasaki_details['angle_difference']:.2f}°")
                print(
    ...
    def remove_redundant_vertices(self) -> None:
        ...
        print(
            f"Removed {len(creases_to_remove)} creases and added "
            f"{len(creases_to_add)} merged creases"
        )
